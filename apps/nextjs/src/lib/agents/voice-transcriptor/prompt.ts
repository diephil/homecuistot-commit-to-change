...
export const PROMPT: Prompt = new Prompt(
  {
    ...
    description:
      "Transcribe audio to text, translate non-English to English, preserve native food names, remove filler words while preserving intent. More balanced prompt",
    versionId: "1.1.0",
    promptId: "1.1.0",
    tags: ["transcription", "voice", "multilingual", "cultural_recipes"],
    type: "mustache",
  },
  client,
);
