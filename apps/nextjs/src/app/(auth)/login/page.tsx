      ...
      <div className={cn(
        ...
        <div className="flex flex-col items-center gap-6 md:gap-8">
          ...
          <div className="w-full text-center -mt-2">
            <Text as="p" className="text-sm md:text-base font-bold text-black/80">
              Track ingredients · Know what&apos;s cookable · Cook more, order less
            </Text>
          </div>
          ...
          <div className="flex flex-col gap-3 md:gap-4 w-full">
            ...
            <Button
              ...
              size="md"
              className={cn(
                "w-full justify-center gap-2 bg-white hover:bg-pink-50 border-4 border-black font-black uppercase text-sm md:text-base",
