...
- N/A (static page, hardcoded mock data) (029-landing-page-revamp)
...
## Recent Changes
- 029-landing-page-revamp: Added TypeScript 5+ (strict mode) + React 19, Next.js 16 App Router, Tailwind CSS v4
