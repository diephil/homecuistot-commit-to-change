  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className={cn("absolute top-10 left-10 w-20 h-20 md:w-32 md:h-32 bg-pink-400 border-3 md:border-4 border-black opacity-30 md:transform md:rotate-12")} />
        <div className={cn("absolute bottom-20 right-10 w-24 h-24 md:w-40 md:h-40 bg-yellow-400 border-3 md:border-4 border-black opacity-30 md:transform md:-rotate-6")} />
        <div className={cn("absolute top-1/2 right-1/4 w-16 h-16 md:w-28 md:h-28 bg-cyan-400 border-3 md:border-4 border-black opacity-30 md:transform md:rotate-45")} />
      </div>
      ...
      <div className={cn(
        ...
        <div className="flex flex-col items-center gap-6 md:gap-8">
          ...
          {/* Milestone badge */}
          <div className={cn(
            "bg-green-400 border-3 md:border-4 border-black px-4 py-2 md:px-6 md:py-3",
          ...
          <div className="flex flex-col gap-4 md:gap-5 w-full">
            ...
            <Button
              ...
              size="lg"
              className={cn(
                "w-full justify-center gap-3 bg-pink-400 hover:bg-pink-500 border-4 border-black font-black uppercase text-base md:text-lg",
                "shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] md:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)]",
                "hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] md:hover:shadow-[3px_3px_0px_0px_rgba(0,0,0,1)]",
                "hover:translate-x-[2px] hover:translate-y-[2px] md:hover:translate-x-[3px] md:hover:translate-y-[3px]",
                "transition-all md:transform md:hover:-rotate-1 py-6 md:py-7"
